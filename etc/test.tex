...
% yes, unlike in LaTeX, you may put \verb|| anywhere, here it is inside an \fbox :)
    ...
    \begin{itemize}
        ...
        Some text
        \fbox{\parbox[c][5cm]{2cm}{parbox default alignment, parbox test text}}
        some text
        \fbox{\parbox[t][5cm]{2cm}{parbox top alignment, text parbox test text}}
        some text
        \fbox{\parbox[b][5cm]{2cm}{parbox bottom alignment, text parbox test text}}
        some text.
% BUG: empty line here causes parse error!
    ...
    \begin{itemize}
        ...
        \noindent
        Some text
        \fbox{\parbox[c][5cm][t]{2cm}{parbox default alignment, parbox test text}}
        some text
        \fbox{\parbox[c][5cm][c]{2cm}{parbox top alignment, text parbox test text}}
        some text
        \fbox{\parbox[c][5cm][b]{2cm}{parbox bottom alignment, text parbox test text}}
        some text.
        ...
        \noindent
        Some text
        \fbox{\parbox[t][5cm][t]{2cm}{parbox default alignment, parbox test text}}
        some text
        \fbox{\parbox[t][5cm][c]{2cm}{parbox top alignment, text parbox test text}}
        some text
        \fbox{\parbox[t][5cm][b]{2cm}{parbox bottom alignment, text parbox test text}}
        some text.
        ...
        \noindent
        Some text
        \fbox{\parbox[b][5cm][t]{2cm}{parbox default alignment, parbox test text}}
        some text
        \fbox{\parbox[b][5cm][c]{2cm}{parbox top alignment, text parbox test text}}
        some text
        \fbox{\parbox[b][5cm][b]{2cm}{parbox bottom alignment, text parbox test text}}
        some text.
